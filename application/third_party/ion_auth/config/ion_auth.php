 ...
 */
$config['site_title']                 = "Natal Solidário";       // Site Title, example.com
$config['admin_email']                = "natalsolidario@heroisdeverdade.org"; // Admin Email, admin@example.com
