...
class Instituicao extends CI_Controller
{
    ...
    function add()
    {
        ...
        if($this->form_validation->run())     
        {
            ...
            $vinculo_id = $this->Instituicao_Model->add_vinculo_instituicao_usuario($params_vinculo_instituicao_usuario);
       ...
       if(isset($data['instituicao']['NU_TBP01']))
        {
            ...
            if($this->form_validation->run())     
            {
                ...
                $vinculo_id = $this->Instituicao_Model->update_vinculo_instituicao_usuario($data['instituicao']['NU_TBP01'], $params_vinculo_instituicao_usuario);
                redirect('instituicao/index');
            }
            else
            {
