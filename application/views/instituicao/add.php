<div class="row">
    <div class="col-md-12">
        <div class="box box-info">
            ...
            <?php echo form_open('instituicao/add'); ?>
            <div class="box-body">
                <div class="row clearfix">
                    <div class="col-md-3">
                        <label for="NU_CNPJ" class="control-label"><span class="text-danger">*</span>CNPJ</label>
                        <div class="form-group">
                            <input type="text" name="NU_CNPJ" value="<?php echo $this->input->post('NU_CNPJ'); ?>"
                ...
                <div class="row clearfix">
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <input type="text" name="NU_CEP" value="<?php echo $this->input->post('NU_CEP'); ?>"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="NO_LOGRADOURO"
                                value="<?php echo $this->input->post('NO_LOGRADOURO'); ?>" class="form-control"
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <input type="text" name="NU_ENDERECO"
                                value="<?php echo $this->input->post('NU_ENDERECO'); ?>" class="form-control"
                                id="NU_ENDERECO" />
                ...
                <div class="row clearfix">
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <input type="text" name="DE_COMPLEMENTO"
                                value="<?php echo $this->input->post('DE_COMPLEMENTO'); ?>" class="form-control"
                                id="DE_COMPLEMENTO" />
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <input type="text" name="NO_BAIRRO" value="<?php echo $this->input->post('NO_BAIRRO'); ?>"
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <input type="text" name="NO_CIDADE" value="<?php echo $this->input->post('NO_CIDADE'); ?>"
                        ...
                        <div class="form-group">
                            <select class="form-control" name="ID_REGIAO_ADMINISTRATIVA" id="ID_REGIAO_ADMINISTRATIVA" required>
                                ...
                                <?php 
                                    foreach($ras as $ra)
                                    {
                                        echo '<option value="' . $ra->id . '"' . ($this->input->post('ID_REGIAO_ADMINISTRATIVA') == $ra->id ? " selected" : "") . '>'
                                                . $ra->nome . 
                                                '</option>';
                                    }
                                ?>
                        ...
                        <div class="form-group">
                            <select class="form-control" name="ID_USUARIO" id="ID_USUARIO" required>
                                ...
                                <?php 
                                    ...
                                    {
                                        echo '<option value="' . $u["id"] . '"' . ($this->input->post('ID_USUARIO') ? " selected" : "") . '>'
                                                    . $u["first_name"] . 
                                                '</option>';
                                    }
                                ?>
