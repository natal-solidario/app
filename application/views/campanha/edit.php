<div class="row">
    <div class="col-md-12">
        <div class="box box-info">
            ...
            <?php echo form_open('campanha/edit/' . $campanha->NU_TBC01); ?>
            <div class="box-body">
                <div class="row clearfix">
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <input type="text" name="NO_CAMPANHA" value="<?php echo $campanha->NO_CAMPANHA; ?>"
                ...
                <div class="row clearfix">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <input type="text" name="AA_CAMPANHA" value="<?php echo $campanha->AA_CAMPANHA; ?>"
