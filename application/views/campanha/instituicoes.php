            ...
            <div class="box-body">
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td>(<?php echo $i['NU_DDD_TELEFONE']; ?>)
                            <?php echo preg_replace("/(\d{4,5})(\d{4})/", "$1-$2", $i['NU_TELEFONE']); ?></td>
                        <td>
                            <a href="<?php echo site_url('campanha/del_instituicao/' . $campanha_id . "/" . $i['NU_TBBC02']); ?>"
